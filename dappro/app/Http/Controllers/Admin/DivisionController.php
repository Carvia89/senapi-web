...
class DivisionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.divisions.index', compact('divisions', 'directions'));
    }
    ...
    {
        $directions = Direction::all();
        return view('admin.divisions.form', compact('directions'));
    }
    ...
    public function edit($id)
    {
        ...
        $directions = Direction::all();
        return view('admin.divisions.edit', compact('division', 'directions'));
    }

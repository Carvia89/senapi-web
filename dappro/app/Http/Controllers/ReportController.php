...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestions.reporting.index', compact('inventaires'));
    ...
    public function create()
    {
        ...
        return view('gestions.reporting.form', compact('articles', 'unites'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('gestions.reporting.fichestock.index', compact('ficheStoks'));

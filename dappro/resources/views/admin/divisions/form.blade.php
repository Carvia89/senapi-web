    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Enregistrement Division</h5>

                <!-- Horizontal Form -->
                <form class="vstack gap-3" action="{{ route('admin.division.store') }}" method="post">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                @foreach ($directions as $direction)
                                    <option value="{{ $direction->id }}" {{ old('direction_id') == $direction->id ? 'selected' : '' }}>{{ $direction->designation }}</option>
                                @endforeach
                                </select>
                                <div style="color: red;">
                                    @error('direction_id')

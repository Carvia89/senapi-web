    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse {{ Request::is('admin/*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('admin.Utilisateur.create') }}" class="{{ Request::routeIs('admin.Utilisateur.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Utilisateurs</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.categorieArticle.create') }}" class="{{ Request::routeIs('admin.categorieArticle.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Catégories Articles</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.uniteArticle.create') }}" class="{{ Request::routeIs('admin.uniteArticle.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Unités Articles</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.Article.create') }}" class="{{ Request::routeIs('admin.Article.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Articles</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.fournisseur.create') }}" class="{{ Request::routeIs('admin.fournisseur.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Fournisseurs</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.direction.create') }}" class="{{ Request::routeIs('admin.direction.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Directions</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.division.create') }}" class="{{ Request::routeIs('admin.division.create') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Divisions</span>
            </a>
          </li>
          <li>
            <a href="{{ route('admin.bureau.create') }}" class="{{ Request::routeIs('admin.bureau.create') ? 'active' : '' }}">

...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav class="d-flex justify-content-between align-items-center">
        ...
        <a type="text" class="btn btn-primary" href="{{ route('admin.Cycle.index') }}">Voir la liste</a>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Modification Cycle</h5>

                <!-- Horizontal Form -->
                <form class="vstack gap-3" action="{{ route('admin.Cycle.update', $cycle->id) }}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" class="form-control
                                        ...
                                        id="designation" value="{{ $cycle->designation }}">
                                    @error('designation')

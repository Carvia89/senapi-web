...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav class="d-flex justify-content-between align-items-center">
        ...
        <a type="text" class="btn btn-primary" href="{{ route('admin.Cycle.create') }}">Ajouter</a>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Liste des Cycles</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 w-100 justify-content-end">
                                        <a href="{{ route('admin.Cycle.edit', $cycle) }}"
                                        title="Editer" class="btn btn-primary"><i class="bi bi-pencil color-muted m-r-5"></i></a>
                                        <form action="{{ route('admin.Cycle.destroy', $cycle) }}" method="post">
                                            @csrf
                                            @method("delete")

...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav class="d-flex justify-content-between align-items-center">
        ...
        <a type="text" class="btn btn-primary" href="{{ route('admin.direction.create') }}">Ajouter</a>
      </nav>
    </div><!-- End Page Title -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 w-100 justify-content-end">
                                        <a href="{{ route('admin.direction.edit', $direction->id) }}" title="Editer" class="btn btn-primary"><i class="bi bi-pencil color-muted m-r-5"></i></a>
                                        <form action="{{ route('admin.direction.destroy', $direction->id) }}" method="post">
                                            @csrf
                                            @method("delete")

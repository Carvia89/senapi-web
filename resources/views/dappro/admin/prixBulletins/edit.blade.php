    ...
    <div class="pagetitle">
        ...
        <nav class="d-flex justify-content-between align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Editer Prix Bulletin</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Editer Prix Bulletin</h5>

                        <!-- Horizontal Form -->
                        <form class="vstack gap-3" action="{{ route('admin.PrixBulletin.update', $price->id) }}" method="POST">
                            @if (Session('success'))
                            ...
                            <div class="row">
                                <div class="row mt-3">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="number" name="prix" class="form-control @error('prix') is-invalid @enderror" id="prix" value="{{ old('prix', $price->prix) }}" required>
                                        @error('prix')
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" id="description" value="{{ old('description', $price->description) }}">
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 w-100 justify-content-end">
                                                <a href="{{ route('admin.PrixBulletin.edit', $price) }}" title="Editer" class="btn btn-primary"><i class="bi bi-pencil color-muted m-r-5"></i></a>

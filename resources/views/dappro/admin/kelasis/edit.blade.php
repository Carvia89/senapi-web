    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Modification Classe</h5>

                <!-- Horizontal Form -->
                <form class="vstack gap-3" action="{{ route('admin.Kelasi.update', $kelasi->id) }}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" class="form-control
                                        ...
                                        id="designation" value="{{ $kelasi->designation }}">
                                    @error('designation')

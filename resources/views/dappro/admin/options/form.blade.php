...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Gestion de Bulletins Scolaires</h1>
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Enregistrement Option</h5>

                <!-- Horizontal Form -->
                <form class="vstack gap-3" action="{{ route('admin.Option.store') }}" method="post">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                @foreach ($niveaux as $niveau)
                                    <option value="{{ $niveau->id }}" {{ old('niveau_id') == $niveau->id ? 'selected' : '' }}>{{ $niveau->designation }}</option>
                                @endforeach
                                </select>
                                <div style="color: red;">
                                    @error('niveau_id')
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach ($cycles as $cycle)
                                    <option value="{{ $cycle->id }}" {{ old('cycle_id') == $cycle->id ? 'selected' : '' }}>{{ $cycle->designation }}</option>
                                @endforeach
                                </select>
                                <div style="color: red;">
                                    @error('cycle_id')

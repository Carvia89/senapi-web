          ...
          <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form class="vstack gap-3" action="{{ route('admin.Article.update', $article->id) }}" method="POST">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror" id="designation" value="{{ $article->designation }}">
                                    @error('designation')
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('categorie_id', $article->categorie_id) == $category->id ? 'selected' : '' }}>{{ $category->designation }}</option>
                                @endforeach
                                </select>
                                <div style="color: red;">
                                    @error('categorie_id')
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="float" name="price" class="form-control @error('price') is-invalid @enderror" id="price" value="{{ $article->price }}">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>

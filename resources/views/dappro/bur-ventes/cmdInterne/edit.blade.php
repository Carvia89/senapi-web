                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.commande-Interne.update', $panier->id) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-end mb-3">
                                                                <a href="{{ route('admin.commande-Interne.edit', $enregistrement->id) }}" title="Editer" class="btn btn-warning btn-circle btn-sm me-4">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <form action="{{ route('admin.commande-Interne.destroy', $enregistrement->id) }}" method="post">
                                                                    @csrf
                                                                    @method("delete")

                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.commande-Interne.store') }}"
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        <div class="table-responsive mt-4">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-end mb-3">
                                                                    <a href="{{ route('admin.commande-Interne.edit', $enregistrement) }}"
                                                                        title="Editer" class="btn btn-warning btn-circle btn-sm me-4">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                    <form action="{{ route('admin.commande-Interne.destroy', $enregistrement) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method("delete")
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <form action="{{ route('admin.generate.pdf') }}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn btn-primary btn-round">

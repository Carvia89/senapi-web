                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Liste de Commandes réapprovisionnées</h5>
                                    <a href="{{ route('admin.appro-Vente.create') }}" class="btn btn-primary btn-round">
                                            ...
                                            @foreach ($enregistrements as $index => $enregistrement)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="badge bg-success">Réapprovisionnée</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach

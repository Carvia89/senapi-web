                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.print.ficheStk.vente') }}" method="GET">
                                        @csrf
                                        @method('GET')
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="date" name="date_debut" class="form-control form-control-round
                                                    @error('date_debut') is-invalid @enderror" id="date_debut" value="{{ old('date_debut') }}">
                                                @error('date_debut')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="date" name="date_fin" class="form-control form-control-round
                                                    @error('date_fin') is-invalid @enderror" id="date_fin" value="{{ old('date_fin') }}">
                                                @error('date_fin')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>

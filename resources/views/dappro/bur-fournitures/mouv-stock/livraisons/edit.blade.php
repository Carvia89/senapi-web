                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.sortie-Fourniture.update', $panier->id) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row mt-3">
                                                    <div class="col-md-6 col-sm-6">
                                                        <label for="qte_livree" class="form-label">Quantité à livrer *</label>
                                                        <input type="number" name="qte_livree" class="form-control form-control-round
                                                            @error('qte_livree') is-invalid @enderror"
                                                            id="qte_livree" value="{{ old('qte_livree', $panier->qte_livree) }}"
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-round" id="solde"

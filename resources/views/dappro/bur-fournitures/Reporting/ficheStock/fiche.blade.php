        ...
        <tbody>
            ...
            @foreach ($entrees as $index => $entree)
                <tr>
                    ...
                    <td style="text-align: right">{{ number_format($entree->quantiteRecu, 0, ',', ' ') }}</td>
                    ...
                    @php
                        ...
                        if ($index == 0) {
                            $stockTotal += $entree->quantiteRecu; // Pour la première ligne
                        } else {
                            $stockTotal = $entree->quantiteRecu + $previousSolde; // Pour les lignes suivantes
                        }
                    @endphp
                    ...
                    @if (isset($sorties[$index]))
                        ...
                        <td style="text-align: right">{{ number_format($sorties[$index]->qte_livree, 0, ',', ' ') }}</td>
                        @php
                            $solde = $stockTotal - $sorties[$index]->qte_livree;
                        @endphp

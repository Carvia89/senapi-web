                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Liste de banques</h5>
                                    <a href="{{ route('admin.banque-senapi.create') }}" class="btn btn-primary btn-round">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td scope="row">{{ $enregistrement->id }}</td>
                                                    <td>{{ $enregistrement->designation }}</td>
                                                    <td>{{ $enregistrement->devise_compte }}</td>
                                                    <td>{{ $enregistrement->description ?? 'Aucune' }}</td>
                                                    <td>
                                                        <div class="d-flex justify-content-end mb-3">
                                                            <a href="{{ route('admin.banque-senapi.edit', $enregistrement) }}"
                                                                title="Editer" class="btn btn-warning btn-circle btn-sm me-4">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <form action="{{ route('admin.banque-senapi.destroy', $enregistrement) }}"
                                                                method="post">
                                                                @csrf
                                                                @method("delete")

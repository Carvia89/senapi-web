                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Modifier l'état de besoin</h5>
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.numérisation-etat-de-besoin.update', $etatBesoin->id) }}"
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                @foreach ($bureaus as $bureau)
                                                    <option value="{{ $bureau->id }}" {{ $etatBesoin->bureau_id == $bureau->id ? 'selected' : '' }}>
                                                        {{ $bureau->designation }}
                                                    </option>
                                                @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                @foreach ($dossiers as $dossier)
                                                    <option value="{{ $dossier->id }}" {{ $etatBesoin->dossier_id == $dossier->id ? 'selected' : '' }}>
                                                        {{ $dossier->designation }}
                                                    </option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="date" name="date_reception"
                                                    ...
                                                    id="date_reception" value="{{ $etatBesoin->date_reception }}">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="number" name="montant"
                                                    ...
                                                    id="montant" value="{{ $etatBesoin->montant }}">
                                                @error('montant')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="file" name="fichier"
                                                    class="form-control form-control-round @error('fichier') is-invalid @enderror"
                                                    id="fichier">
                                                ...
                                                @if($etatBesoin->fichier)
                                                    <div class="mt-2">
                                                        <a href="{{ asset($etatBesoin->fichier) }}" target="_blank" class="btn btn-link">
                                                            {{ basename($etatBesoin->fichier) }}
                                                        </a>
                                                        <span class="text-muted"> (Fichier existant)</span>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="description"
                                                    ...
                                                    id="description" value="{{ $etatBesoin->description }}">
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>

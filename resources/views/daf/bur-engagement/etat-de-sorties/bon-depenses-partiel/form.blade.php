                    ...
                    <div class="col-sm-10">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5>Bon de Dépense Partielle</h5>
                            ...
                            <div class="card-block">
                                ...
                                <div style="font-size: 15px; font-weight: bold; font-family: Arial, sans-serif; text-align: center">
                                    <span>BON DE DEPENSE PARTIELLE</span>
                                </div><br>

                                <form class="vstack gap-3" action="{{ route('admin.bon-de-dépense-partielle.store') }}"
                                    ...
                                    <div class="form-group row mt-2">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            style="font-size: 15px; font-weight: bold;">* MONTANT GLOBAL (CDF) </label>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="text" name="montant_acompte"
                                                class="form-control form-control-round
                                                    ...
                                                    style="font-size: 15px; font-weight: bold; text-align: right"
                                                id="montant_acompte" value="{{ old('montant_acompte') }}">
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="date" name="date_paiement"
                                                ...
                                                id="date_paiement" value="{{ old('date_paiement') }}">
                                            @error('date_paiement')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="text" name="beneficiaire"
                                                ...
                                                id="beneficiaire" value="{{ old('beneficiaire') }}">
                                            @error('beneficiaire')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

...
<body>
    ...
    <table class="tableau-acquit">
        ...
        <tbody>
            <tr style="font-family: Arial, sans-serif; font-size: 12px;">
                <td style="width:40px; height: 80px;"> </td>   <!-- 1ère colonne -->
    ...
    <p style="font-size: 12px; font-family: Arial, sans-serif; font-weight: bold;">PAIEMENT PAR ACOMPTES</p>
    <!-- Tableau PAIEMENT ACOMPTE -->
    <table class="tableau-acompte">
        <thead>
            <tr>
                <th>N°</th>
                <th>DATES</th>
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>{{ \Carbon\Carbon::parse($datePaiement1)->format('d/m/Y') }}</td>
                <td>{{ number_format($montantAcompte, 2, ',', ' ') }}</td>
                <td>{{ $benef }}</td>
                <td>{{ $NumEnreg }}</td>
                <td>Caisse</td>
                <td></td>

                    ...
                    <div class="col-sm-10">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5>Modifier le Bon de Dépense Complète</h5>
                            ...
                            <div class="card-block">
                                ...
                                <form class="vstack gap-3" action="{{ route('admin.bon-de-dépense-complète.update', $bon->id) }}"
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="date" name="date_acquit"
                                                ...
                                                id="date_acquit" value="{{ old('date_acquit', $bon->date_acquit) }}">
                                            @error('date_acquit')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="text" name="pour_acquit"
                                                ...
                                                id="pour_acquit" value="{{ old('pour_acquit', $bon->pour_acquit) }}">
                                            @error('pour_acquit')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

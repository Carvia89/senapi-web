                    ...
                    <div class="col-sm-10">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5>Bon de Dépense Complète</h5>
                                <a href="{{ route('admin.bon-de-dépense-complète.index') }}" class="btn btn-primary btn-round">
                            ...
                            <div class="card-block">
                                ...
                                <form class="vstack gap-3" action="{{ route('admin.bon-de-dépense-complète.store') }}"
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="text" name="num_bon"
                                                ...
                                                id="num_bon" value="{{ $num_bon }}" readonly>
                                            @error('num_bon')
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="text" name="num_enreg"
                                                ...
                                                id="num_enreg" value="{{ $num_Enreg }}" readonly>
                                            @error('num_enreg')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="date" name="date_emission"
                                                class="form-control form-control-round
                                                    ...
                                                    style="font-size: 15px; font-family: Arial, sans-serif;
                                                    text-align: left;"
                                                id="date_emission" value="{{ old('date_emission') }}">
                                            @error('date_emission')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mt-2">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            @foreach ($etatBesoins as $etatBesoin)
                                                <option value="{{ $etatBesoin->id }}" {{ old('etat_besoin_id') == $etatBesoin->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            @foreach ($beneficiaires as $benef)
                                                <option value="{{ $benef->id }}" {{ old('beneficiaire_id') == $benef->id ? 'selected' : '' }}>
                                                    {{ $benef->nom }}
                                                </option>
                                            @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="text" name="montant_bon"
                                                ...
                                                id="montant_bon" value="{{ old('montant_bon') }}">
                                            @error('montant_bon')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-md-4 col-sm-4">
                                            <label for="date_acquit" class="form-label"
                                            style="font-size: 15px; font-weight: bold;">Date d'acquitement  </label>
                                            <input type="date" name="date_acquit"
                                                class="form-control form-control-round
                                                    @error('date_acquit') is-invalid @enderror"
                                                id="date_acquit" value="{{ old('date_acquit') }}">
                                            @error('date_acquit')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <label for="pour_acquit" class="form-label"
                                            style="font-size: 15px; font-weight: bold;">Pour Acquit </label>
                                            <input type="text" name="pour_acquit"
                                                class="form-control form-control-round
                                                    @error('pour_acquit') is-invalid @enderror"
                                                id="pour_acquit" value="{{ old('pour_acquit') }}">
                                            @error('pour_acquit')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>

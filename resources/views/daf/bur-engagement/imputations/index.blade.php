                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Tableau d'imputations</h5>
                                    <a href="{{ route('admin.imputation.create') }}" class="btn btn-primary btn-round">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td scope="row">{{ $imput->id }}</td>
                                                    <td>{{ $imput->imputation }}</td>
                                                    <td>{{ $imput->designation }}</td>
                                                    <td>
                                                        <div class="d-flex justify-content-end mb-3">
                                                            <a href="{{ route('admin.imputation.edit', $imput) }}"
                                                                title="Editer" class="btn btn-warning btn-circle btn-sm me-4">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <form action="{{ route('admin.imputation.destroy', $imput) }}"
                                                                method="post">
                                                                @csrf
                                                                @method("delete")

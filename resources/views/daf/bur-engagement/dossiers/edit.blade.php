                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Modification de Dossiers d'impression</h5>
                                </div>
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.dossier.update', $dossier->id) }}"
                                        method="POST">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="text" name="designation"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="designation" value="{{ old('designation', $dossier->designation) }}">
                                                @error('designation')
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="description"
                                                    ...
                                                    id="description" value="{{ old('description', $dossier->description) }}">
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>

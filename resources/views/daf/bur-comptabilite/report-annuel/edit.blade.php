                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Modification du Report Annuel</h5>
                                </div>
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.report-annuel.update', $report->id) }}"
                                        method="POST">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="date" name="annee"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="annee" value="{{ old('annee', $report->annee) }}">
                                                @error('annee')
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="text" name="montant_report"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="montant_report" value="{{ old('montant_report', $report->montant_report) }}">
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="description"
                                                    ...
                                                    id="description" value="{{ old('description', $report->description) }}">
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>

                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Modification des Mot de Référence</h5>
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.mot-cle-imputation.update', $reference->id) }}"
                                        method="POST">
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                @foreach ($imputations as $imputation)
                                                    <option value="{{ $imputation->id }}" {{ $reference->imputation_id == $imputation->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="designation"
                                                    ...
                                                    id="designation" value="{{ old('designation', $reference->designation) }}">
                                                @error('designation')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>

                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.recettes-caisse.update', $recette->id) }}"
                                        method="POST">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="date" name="date_recette"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="date_recette" value="{{ old('date_recette', $recette->date_recette) }}">
                                                @error('date_recette')
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="text" name="montant_recu"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="montant_recu" value="{{ old('montant_recu', $recette->montant_recu) }}">
                                                @error('montant_recu')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="libelle"
                                                    ...
                                                    id="libelle" value="{{ old('libelle', $recette->libelle) }}">
                                                @error('libelle')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                @foreach ($referImputs as $referImput)
                                                    <option value="{{ $referImput->id }}" {{ $recette->reference_imputation_id == $referImput->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                @foreach ($dossiers as $dossier)
                                                    <option value="{{ $dossier->id }}" {{ $recette->dossier_id == $dossier->id ? 'selected' : '' }}>
                                                        {{ $dossier->designation }}
                                                    </option>
                                                @endforeach
                                                </select>

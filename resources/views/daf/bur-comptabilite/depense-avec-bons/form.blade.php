                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Enregistrements des Dépenses</h5>
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.dépenses-avec-bons.store') }}"
                                        method="POST">
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="date" name="date_depense"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="date_depense" value="{{ old('date_depense', session('date_depense', '')) }}">
                                                @error('date_depense')
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                @foreach ($bons as $bon)
                                                    <option value="{{ $bon->id }}" {{ old('bon_depense_id') == $bon->id ? 'selected' : '' }}>
                                                        {{ $bon->num_bon }}
                                                    </option>
                                                @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="text" name="imputation"
                                                    class="form-control form-control-round
                                                        ...
                                                        id="imputation" value="{{ old('imputation') }}" readonly>
                                                @error('imputation')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="motif"
                                                    ...
                                                    id="motif" value="{{ old('motif') }}" readonly>
                                                @error('motif')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="text" name="montant_bon"
                                                    ...
                                                    id="montant_bon" value="{{ old('montant_bon') }}" readonly style="font-weight: bold; text-align: right;">
                                                @error('montant_bon')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="text" name="beneficiaire"
                                                    ...
                                                    id="beneficiaire" value="{{ old('beneficiaire') }}" readonly>
                                                @error('beneficiaire')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <input type="date" name="date_emission"
                                                    ...
                                                    id="date_emission" value="{{ old('date_emission') }}" readonly>
                                                @error('date_emission')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>

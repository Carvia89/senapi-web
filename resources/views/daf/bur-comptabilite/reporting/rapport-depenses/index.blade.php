                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form class="vstack gap-3" action="{{ route('admin.rap.depense.pdf') }}"
                                        method="GET">
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                <label for="reference_imputation_id" class="form-label">Rubrique d'imputation </label>
                                                ...
                                                @foreach ($references as $reference)
                                                    <option value="{{ $reference->id }}" {{ old('reference_imputation_id') == $reference->id ? 'selected' : '' }}>

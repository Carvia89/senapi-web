...
class BureauController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dappro.admin.bureaux.index', compact('bureaus', 'divisions'));
    }
    ...
    {
        $divisions = Division::all();
        return view('dappro.admin.bureaux.form', compact('divisions'));
    }
    ...
    public function edit($id)
    {
        ...
        $divisions = Division::all();
        return view('dappro.admin.bureaux.edit', compact('bureau', 'divisions'));
    }

...
class InStockController extends Controller
{
    ...
    {
        $entreestocks = InStock::orderBy('created_at', 'desc')->paginate(25);
        $articles = Article::all();
        $unites = UnitArticle::all();
        $fournisseurs = Fournisseur::all();

        return view('dappro.gestions.entrees.index',
            compact(
                'entreestocks',
                'articles',
                'unites',
    ...
    public function create()
    {
        ...
        return view('dappro.gestions.entrees.form',
            compact(
                'articles',
                'unites',
                'fournisseurs'
    ...
    public function edit($id)
    {
        ...
        return view('dappro.gestions.entrees.edit',
            compact(
                'entreestock',
                'articles',
                'unites',

...
$("body").append('<div class="fixed-button active"><a href="#" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-user" aria-hidden="true"></i> Directeur Général</a> </div>');var $window=$(window),nav=$(".fixed-button");

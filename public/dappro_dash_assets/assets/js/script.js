...
$("body").append('<div class="fixed-button active"><a href="' + infoUrl + '" class="btn btn-md btn-primary"><i class="fab fa-whatsapp" aria-hidden="true"></i> Contactez-nous</a> </div>');var $window=$(window),nav=$(".fixed-button");
